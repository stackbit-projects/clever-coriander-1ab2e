...
import {toStyleObj, withPrefix, Link, getPage, getPages} from '../utils';
                    ...
                    <section className="product content__row content__row--full-width">
                        ...
                        <div className="product__details">
                            ...
                            {_.get(this.props, 'pageContext.frontmatter.category', null) && ((() => {
                                let category_page = getPage(this.props.pageContext.pages, _.get(this.props, 'pageContext.frontmatter.category', null).stackbit_url_path);
                                return (
