...
import {getPage, withPrefix} from '../utils';
        ...
        return (
            <button className={component + '__item-buy button button--icon-only snipcart-add-item'}
                ...
                {...(_.get(product_page, 'frontmatter.category', null) ? ((() => {
                    let category_page = getPage(this.props.pageContext.pages, _.get(product_page, 'frontmatter.category', null).stackbit_url_path);
